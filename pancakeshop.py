...
trilogy = ["The Fellowship of the Ring", "The Two Towers", "The Return of the King"]
...
the_best = make_short_stack(trilogy)
print(the_best)
print(the_best.magnitude_pop_pop())
print(the_best)